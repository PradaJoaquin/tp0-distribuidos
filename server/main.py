...
def initialize_config():
    ...
    try:
        ...
        config_params["number_of_clients"] = int(os.getenv('NUMBER_OF_CLIENTS', config["DEFAULT"]["NUMBER_OF_CLIENTS"]))
...
def main():
    ...
    server = Server(port, listen_backlog, config_params["number_of_clients"])
